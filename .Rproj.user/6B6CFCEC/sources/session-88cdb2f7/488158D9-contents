...
cdchealthvars <- c("GENHLTH", "PHYSHLTH", "MENTHLTH", "POORHLTH", "EMPLOY1", "EXERANY2", "X_RFBING5", "AVEDRNK3", "ALCDAY5", "ACEDRUGS", "ACEDEPRS", "SMOKDAY2", "USENOW3", "MARIJAN1", "HLTHPLN1", "ADDEPEV3")
...
calc <- c("IDATE", "QSTLANG", "X_SEX", "X_EDUCAG", "X_URBSTAT", "X_METSTAT", "X_IMPRACE",
          ...
          "CHILDREN", "MARITAL", "CHECKUP1", "MEDCOST", "PERSDOC2", "MSCODE")
...
rm(basiclayer, clean_cdc, load_cdc)
