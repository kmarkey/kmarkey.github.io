...
One more thing to know about the tidyverse is that it utilizes lazy evaluation and data masking.
This sounds fancy, but all it really means is that once we pass data to
...
![Regression and Classification](/figs/regression-vs-classification-in-machine-learning.png)
...
way, but the model should be able to produce insights
into data not available for standard data analysis using this relationship of input-output.
