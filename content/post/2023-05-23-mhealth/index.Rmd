...
plotly_chloropleth(data = data, z = "per", colors = "Oranges", tick_breaks = c(0.12, 0.14, 0.16, 0.18, 0.20), symbol = "%") %>%
...
plotly_chloropleth(data = data, z = "total", title = "Hello", colors = "Oranges", tick_breaks = c(0.80, 1.00, 1.20, 1.40)) %>%
    plotly_anno(text = "Data source: BRFSS 2020")
