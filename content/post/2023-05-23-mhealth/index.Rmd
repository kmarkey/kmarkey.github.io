...
```{r chunk9, echo=FALSE, warning=FALSE}
...
which translates to about 33 million people. Financial cost is a huge
barrier to treatment. Nationally, about 50% of facilities offer payment
...
Although **these questions don't implicate the respondent directly** and
less than half of all states reported data, I think the results are
still interesting, and may more accurately represent the level of mental
illness in the region due to response bias. However, they also may be
affected by the rate of cohabitation.
...
[[https://www.va.gov/health-care/eligibility/#:\\\\](https://www.va.gov/health-care/eligibility/#:){.uri}](%5Bhttps://www.va.gov/health-care/eligibility/#:%5D(https://www.va.gov/health-care/eligibility/#:)%7B.uri%7D){.uri}
