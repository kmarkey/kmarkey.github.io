...
# knitr::opts_knit$set(base.dir = 'assets')
library(ggplot2)
...
# knitr options
knitr::opts_chunk$set(dev.args = list(bg = bgcolor))
...
my_theme <- function() {
    ...
    theme(
      panel.background = element_rect(fill=bgcolor), #transparent panel bg
      plot.background = element_rect(fill=bgcolor, color = linecolor),
      legend.background = element_rect(fill=bgcolor), #transparent legend bg
      legend.box.background = element_rect(fill=bgcolor) #transparent legend panel
  )
}
...
transparent_theme <- function() {
    ...
    theme(
      panel.background = element_rect(fill=bgcolor, color = linecolor), #transparent panel bg
      plot.background = element_rect(fill=bgcolor, color = linecolor),
      panel.grid.major = element_line(color = bgcolor), #remove major gridlines
      panel.grid.minor = element_line(color = bgcolor), #remove minor gridlines
      legend.background = element_rect(fill=bgcolor), #transparent legend bg
      legend.box.background = element_rect(fill=linecolor) #transparent legend panel
  )
}
