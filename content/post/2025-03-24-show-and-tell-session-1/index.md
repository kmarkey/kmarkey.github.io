...
This Show & Tell was a part of a series a coworker and I put together to help colleagues get more acquainted with R and overcome the scary feeling we all had when learning to code.

# Introduction

Data Visualization is a super important (and super fun) part of any
project.
...
Let’s get a glimpe of the data.
...
## Let’s jump in and get plotting!
...
## Don’t forget to tidy your data!

- Half of the battle is organizing your data correctly before you start
...
- There’s tons of theory and other things to consider during data
  visualization!
